...
async function main() {
  ...
  const artists = [
    ...
    { name: 'Gayatri', role: 'Female Vocalist', specialty: 'Bhajan, Sufi, Ghazal', bio: 'Classically trained singer specialising in devotional bhajans and Sufi music. Her soulful voice elevates every spiritual event.', avatar: '/images/artists/artist-2.png', phone: '7979962408', featured: true, order: 2 },
    { name: 'Vikas Sharma', role: 'Anchor / Emcee', specialty: 'Wedding, Corporate', bio: 'Professional emcee who keeps the energy high at weddings, sangeet nights, and corporate events with his witty hosting.', avatar: '/images/artists/artist-3.png', order: 3 },
    { name: 'Suresh Kumar', role: 'Musician', specialty: 'Harmonium, Keyboard', bio: 'Master harmonium and keyboard player accompanying singers at Jagrans, bhajan sandhyas, and wedding ceremonies.', avatar: '/images/artists/artist-4.png', order: 4 },
    { name: 'Amit Singh', role: 'Musician', specialty: 'Tabla, Dholak', bio: 'Expert tabla and dholak player bringing rhythm to spiritual events and sangeet nights.', avatar: '/images/artists/artist-5.png', order: 5 },
    { name: 'The Rahul Band', role: 'Band Member', specialty: 'Live Band', bio: 'A 6-piece live band featuring vocalists, guitarists, keyboardist, and drummer for concerts and stage shows.', avatar: '/images/artists/artist-6.png', order: 6 },
  ];
  ...
  for (const u of upcoming) {
    await db.upcomingEvent.create({
      data: {
        ...u,
        coverImage: '/images/events/jagran.png',
        published: true,
      },
    });
  }
  ...
  const galleryItems = [
    ...
    { title: 'Sundarkand Path', category: 'Spiritual', type: 'photo', url: '/images/events/sundarkand.png', description: 'Recitation of Sundarkand.' },
  ...
  const settings = [
    ...
    { key: 'email', value: 'booking@rahuleventsnight.online' },
    { key: 'website', value: 'rahuleventsnight.online' },
    { key: 'address', value: 'Delhi NCR, India' },
    { key: 'instagram', value: '#' },
    { key: 'facebook', value: '#' },
    { key: 'youtube', value: '#' },
